...
<body>
    <header>
        <div class="container">
            ...
            <div class="nav-btn">
                                ...
                                <ul>
                                    ...
                                    if ($isLogged && ($ruolo == "staff")) {
                                        echo '<li class="dropdown-link">
                                            <a href="#">Multe e comunicazioni</a>
                                        </li>';
                                    }
                                    if ($isLogged && ($ruolo == "gestore")) {
                                        echo '<li class="dropdown-link">
                                            <a href="#">Gestione parcheggi</a>
                                        </li>';
                                    }
                ...
                <a href="../logpage/login.php" class="btn transparent">
            <?php if($isLogged) { echo "$nome $cognome"; }
                else{echo"Log in";}
            ?>
    </a>
    ...
    <script>
    console.log('<?php echo isset($_SESSION["mail"]) ? $_SESSION["mail"] : ""; ?>');
</script>
